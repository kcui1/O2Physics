...
struct correlateStrangeness {
  ...
  void init(InitContext const&)
  {
    ...
    if (doprocessMCGenerated) {
      ...
      histos.add("Generated/sameEvent/Pion", "Pion", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/K0Short", "K0Short", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/Lambda", "Lambda", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/AntiLambda", "AntiLambda", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/XiMinus", "XiMinus", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/XiPlus", "XiPlus", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/OmegaMinus", "OmegaMinus", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/sameEvent/OmegaPlus", "OmegaPlus", kTHnF, {axisDeltaPhiNDim, axisDeltaEtaNDim, axisPtAssocNDim, axisPtTriggerNDim, axisVtxZNDim, axisMultNDim});
      histos.add("Generated/TriggerTrack", "TriggerTrack", kTH3F, {axisPtQA, axisEta, axisPhi});
  ...
  void processMCGenerated(aod::McCollision const&, soa::SmallGroups<soa::Join<aod::McCollisionLabels, aod::Collisions, aod::EvSels, aod::CentFT0Ms>> const& collisions, aod::McParticles const& mcParticles)
  {
    ...
    for (auto const& mcParticle : mcParticles) {
      ...
      Int_t globalIndex = mcParticle.globalIndex();
    ...
    for (auto const& mcParticle : mcParticles) {
      Int_t globalIndexTrigger = mcParticle.globalIndex();
      bool foundTrigger = std::binary_search(triggerIndices.begin(), triggerIndices.end(), globalIndexTrigger);
      if(!foundTrigger){
        continue;
        }
      Double_t geta = mcParticle.eta();
      Double_t gphi = mcParticle.phi();
      Double_t pttrigger = mcParticle.pt();
      histos.fill(HIST("Generated/TriggerTrack"), pttrigger, geta, gphi);
      //Int_t iTrigMother0 = lTriggerParticle.mother0Id();
      //Int_t iTrigMother1 = lTriggerParticle.mother1Id();
      for (auto const& mcParticleAss : mcParticles) {
        Int_t globalIndexAss = mcParticleAss.globalIndex();
        static_for<0, 7>([&](auto i){   // associated loop
          constexpr int index = i.value;
          bool foundAss = std::binary_search(associatedIndices[index].begin(), associatedIndices[index].end(), globalIndexAss);
          if(foundAss && globalIndexTrigger!= globalIndexAss ){ // avoid self
            //if( iTrigMother0 == associatedIndices[iassocSpecies][iassoc] ||iTrigMother1 == associatedIndices[iassocSpecies][iassoc] ) continue; // avoid self
            Double_t geta2 = mcParticleAss.eta();
            Double_t gphi2 = mcParticleAss.phi();
            Double_t ptassoc    = mcParticleAss.pt();
            histos.fill(HIST("Generated/sameEvent/") + HIST(particlenames[index]), ComputeDeltaPhi(gphi,gphi2), geta2-geta, ptassoc, pttrigger, bestCollisionVtxZ, bestCollisionFT0Mpercentile);
          }
        });
      }
    }
